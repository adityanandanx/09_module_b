...
const CreateCompany = ({ company }: { company: Company }) => {
    const { data, setData, put, errors, processing } = useForm<Omit<Company, 'deactivated'>>(company);
    ...
    return (
        <div className="mx-auto flex max-w-xl flex-col gap-10 p-10">
            <h1 className="text-5xl font-bold">Edit Company</h1>
            <form
                onSubmit={(e) => {
                    e.preventDefault();
